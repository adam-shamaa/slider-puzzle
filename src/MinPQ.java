...
public class MinPQ <Key extends Comparable>{
    ...
    public Key delMin() {   
        ...
        pq[1] = pq[currentIndex--]; pq[currentIndex+1] = null;  //place key located the end of the tree to the root and re-validate heap using sink()
        sink(1);
    ...
    private void exch(int indexA, int indexB) {
        Key temp = pq[indexA]; pq[indexA] = pq[indexB]; pq[indexB] = temp;
    }
}
